...
from articleapp.views import AritcleCreateView, AritcleDetailView, AritcleUpdateView, AritcleDeleteView, AritcleListView
...
urlpatterns = [
    ...
    path('list/', AritcleListView.as_view(), name='list'),
